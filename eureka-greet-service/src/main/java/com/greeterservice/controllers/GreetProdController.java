...
@RestController
@Profile("prod")
public class GreetProdController {
	
	@Autowired
	private IMessengerService messengerService;
	
	@GetMapping("/message11")
	String showMessage(){
...
//	http://localhost:8081/greeter/username/priya
	@GetMapping("/greeter11/username/{username}")
...
//	http://localhost:8081/greeter/show-books
	@GetMapping("/greeter11/show-books")
...
//	http://localhost:8081/greeter/print/userdetails?username=Priya
	@GetMapping("/greeter11/print/userdetails")
